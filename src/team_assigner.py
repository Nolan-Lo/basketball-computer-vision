...
class TeamAssigner:
    ...
    def load_model(self):
        ...
        Uses the fashion-clip model which is fine-tuned for clothing classification.
        """
    ...
    def get_player_color(self, frame, bbox):
        ...
        Args:
            ...
            bbox (tuple): Bounding box coordinates of the player (x1, y1, x2, y2).
    ...
    def get_player_teams_across_frames(self, video_frames, player_tracks, read_from_stub=False, stub_path=None):
        ...
        Args:
            ...
            player_tracks (list): List of player tracking information for each frame.
                                 Each element should be a dict mapping player_id to track info
                                 with 'bbox' key containing bounding box coordinates.
        ...
        for frame_num, player_track in enumerate(player_tracks):        
            ...
            # Reset player_team_dict every 50 frames to allow for jersey changes/substitutions
            if frame_num % 50 == 0:
                self.player_team_dict = {}
